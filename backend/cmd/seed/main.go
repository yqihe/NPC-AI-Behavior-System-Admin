...
func main() {
	...
	fieldTypes := []model.Dictionary{
		{GroupName: "field_type", Name: "integer", Label: "整数", SortOrder: 1, Extra: mustRawJSON(map[string]any{
		...
		{GroupName: "field_type", Name: "float", Label: "浮点数", SortOrder: 2, Extra: mustRawJSON(map[string]any{
			"constraint_schema": map[string]any{
				"type": "object",
				"properties": map[string]any{
					"min":       map[string]any{"type": "number", "title": "最小值"},
		...
		{GroupName: "field_type", Name: "string", Label: "文本", SortOrder: 3, Extra: mustRawJSON(map[string]any{
			"constraint_schema": map[string]any{
				"type": "object",
				"properties": map[string]any{
		...
		{GroupName: "field_type", Name: "boolean", Label: "布尔", SortOrder: 4, Extra: mustRawJSON(map[string]any{
			"constraint_schema": map[string]any{
				"type":       "object",
				"properties": map[string]any{},
			},
		})},
		{GroupName: "field_type", Name: "select", Label: "选择", SortOrder: 5, Extra: mustRawJSON(map[string]any{
			"constraint_schema": map[string]any{
				"type": "object",
				"properties": map[string]any{
		...
		{GroupName: "field_type", Name: "reference", Label: "引用", SortOrder: 6, Extra: mustRawJSON(map[string]any{
			"constraint_schema": map[string]any{
				"type": "object",
				"properties": map[string]any{
					"refs": map[string]any{
	...
	fieldCategories := []model.Dictionary{
		{GroupName: "field_category", Name: "basic", Label: "基础属性", SortOrder: 1},
		{GroupName: "field_category", Name: "combat", Label: "战斗属性", SortOrder: 2},
		{GroupName: "field_category", Name: "perception", Label: "感知属性", SortOrder: 3},
		{GroupName: "field_category", Name: "movement", Label: "移动属性", SortOrder: 4},
		{GroupName: "field_category", Name: "interaction", Label: "交互属性", SortOrder: 5},
		{GroupName: "field_category", Name: "personality", Label: "个性属性", SortOrder: 6},
	}

	// field_properties: 4 种动态表单属性
	fieldProperties := []model.Dictionary{
		{GroupName: "field_properties", Name: "description", Label: "描述说明", SortOrder: 1, Extra: mustRawJSON(map[string]any{
			"input_type": "textarea", "required": false,
		})},
		{GroupName: "field_properties", Name: "expose_bb", Label: "暴露 BB Key", SortOrder: 2, Extra: mustRawJSON(map[string]any{
			"input_type": "radio_bool", "required": true, "default": false,
		})},
		{GroupName: "field_properties", Name: "default_value", Label: "默认值", SortOrder: 3, Extra: mustRawJSON(map[string]any{
			"input_type": "dynamic", "required": false,
		})},
		{GroupName: "field_properties", Name: "constraints", Label: "约束配置", SortOrder: 4, Extra: mustRawJSON(map[string]any{
