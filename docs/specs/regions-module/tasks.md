...
## T5：store/redis/region_cache.go （R15）  `[x]` 完成 2026-04-20
...
## T6：service/region.go — CRUD 骨架 （R2-R7）  `[x]` 完成 2026-04-20
...
## T7：service/region.go — validateSpawnTable + Create/Update hook （R8）  `[x]` 完成 2026-04-20
...
## T8：service/region.go — Export 4 纯方法 （R9, R10）  `[x]` 完成 2026-04-20
...
## T9：handler/region.go CRUD 7 端点 + router + setup （R2-R7, R12）  `[x]` 完成 2026-04-20
...
## T10：handler/export.go +Regions() 5 步编排 （R9, R10, R17）  `[x]` 完成 2026-04-20
...
## T11：service/region_test.go 10 用例 （R16）  `[x]` 完成 2026-04-20
...
## T12：seed region_type 字典 + village_outskirts fixture （R11）  `[x]` 完成 2026-04-20
...
## T13：frontend/src/api/regions.ts （R12, R13）  `[x]` 完成 2026-04-20
...
## T14：RegionList.vue + 路由 + 菜单 （R12）  `[x]` 完成 2026-04-20
...
## T15：RegionForm.vue 含嵌套 array 编辑器 （R13, R14）  `[x]` 完成 2026-04-20
...
## T16：后端 e2e 手动验证 （R16 的 e2e 验证）  `[x]` 完成 2026-04-20（结果 [t16-smoke-result.md](t16-smoke-result.md)）
...
## T17：前端手测（R12-R14 e2e）  `[x]` 完成 2026-04-20（MCP Playwright 自动化，结果 [t17-frontend-result.md](t17-frontend-result.md)）
