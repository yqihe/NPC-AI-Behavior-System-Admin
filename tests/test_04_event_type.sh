...
assert_field "1.4 global range=0" '.data.config.range' "0" "$body"
...
assert_code "2.3 severity=-1 → 42004" "42004" "$body"
...
assert_code "2.4 severity=101 → 42004" "42004" "$body"
...
assert_code "3.2 ttl=0 → 42005" "42005" "$body"
...
assert_code "3.3 ttl=-1 → 42005" "42005" "$body"
...
assert_code "4.2 range=-1 → 42006" "42006" "$body"
...
assert_code "7.4 启用后编辑 → 42015" "42015" "$body"
